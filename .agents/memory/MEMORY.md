...
- [SPCX password authentication](spcx-password-auth.md) — store new passwords as salted hashes; keep legacy credential columns nullable until reset support exists.
